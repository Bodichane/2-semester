...
public:
  ...
  DoubleLinkedList();
  /**
   * @brief Constructs a new linked list initialized with the elements of
   * the provided initializer list.
   *
   * @param lst The initializer list of elements to initialize the linked list
   * with.
   */
  DoubleLinkedList(std::initializer_list<T> lst);
  /**
   * @brief Constructs a new linked list with the same elements as another
   * linked list.
   *
  ...
  /**
   * @brief Destroys the linked list and deallocates the memory used by the
   * nodes.
   */
  ~DoubleLinkedList();
  /**
  ...
  /**
   * @brief Returns a reference to the data stored in the node at the given
   * index.
  ...
  /**
   * @brief Returns a const reference to the data stored in the node at the
   * given index.
   * @param index The index of the node to retrieve the data from.
  ...
  /**
   * @brief Returns a string representation of the linked list, with the
  ...
  /**
   * @brief Prints the string representation of the linked list to the given
   * output stream.
   ...
   * @return std::ostream& The output stream after printing the string
   * representation.
   */
